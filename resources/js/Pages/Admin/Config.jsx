                ...
                <main className="mx-auto max-w-7xl ">
                    ...
                    <div className="max-w-3xl mx-auto bg-blue-900/15 p-4 md:p-12 min-h-[500px] flex flex-col gap-y-20 ">
                        ...
                        <div>
                            ...
                            <p className=" mb-6 ">PHP OR your webserver default upload limits are too small for most
                                people. </p>
                            ...
                            <p className="text-lg text-blue-200 mt-10 mb-5 font-bold">Instructions for various apps
                                :</p>
                            <div className="flex flex-col text-gray-300">

                                <div><span className="font-bold text-lg text-gray-100"> php-fpm:</span> Edit the
                                    www.conf file
...
php_value[max_file_uploads] = 1000`}
                                ...
                                <div><span className="font-bold text-lg text-gray-100"> PHP:</span> Edit 3 variables in
                                    php.ini file
                                    <pre className="mt-1 mb-5 text-sm text-gray-400">
...
max_file_uploads = 10000`}
                                ...
                                <div><span className="font-bold text-lg text-gray-100"> apache:</span> edit the
...
php_value max_file_uploads 10000`}
                                ...
                                <div><span className="font-bold text-lg text-gray-100"> nginx:</span> Increase
                                    client_max_body_size param
                                    <pre className="mt-1 mb-5 text-sm text-gray-400">
                                {`http {
    client_max_body_size 1000M;
                                ...
                                <div><span className="font-bold text-lg text-gray-100"> Caddy:</span> Increase
        ...
        timeout 1000s
                        ...
                        <div className="  ">
                            ...
                            <h2 className=" text-blue-200 text-xl font-bold mb-2 ">Refresh Database and cancel all
                                Shares </h2>
                            <p className="mb-4">'Reset' option. This will reindex all files, remove all shares,
                                regenerate thumbnail</p>
                            <RefreshButton/>
